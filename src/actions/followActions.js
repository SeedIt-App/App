...
export const GET_ALL_USER_FOLLOWINGS_REQUEST = 'AUTH/GET_ALL_USER_FOLLOWINGS_REQUEST';
export const GET_ALL_USER_FOLLOWINGS_SUCCESS = 'AUTH/GET_ALL_USER_FOLLOWINGS_REQUEST';
export const GET_ALL_USER_FOLLOWINGS_FAILURE = 'AUTH/GET_ALL_USER_FOLLOWINGS_FAILURE';
...
export const getAllUserFollowingsSuccess = createAction(GET_ALL_USER_FOLLOWINGS_REQUEST);

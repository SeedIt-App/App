...
// State for all tag followers list
	...
	export const GET_ALL_FOLLOWERS_TAG_REQUEST = 'TAGS/GET_ALL_FOLLOWERS_TAG_REQUEST';
	export const GET_ALL_FOLLOWERS_TAG_SUCCESS = 'TAGS/GET_ALL_FOLLOWERS_TAG_SUCCESS';
	export const GET_ALL_FOLLOWERS_TAG_FAILURE = 'TAGS/GET_ALL_FOLLOWERS_TAG_FAILURE';

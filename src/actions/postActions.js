...
export const ADD_NEW_COMMENT_TO_POST_REQUEST =
  'POST/ADD_NEW_COMMENT_TO_POST_REQUEST';
export const ADD_NEW_COMMENT_TO_POST_SUCCESS =
  'POST/ADD_NEW_COMMENT_TO_POST_SUCCESS';
export const ADD_NEW_COMMENT_TO_POST_FAILURE =
  'POST/ADD_NEW_COMMENT_TO_POST_FAILURE';
...
export const REPLY_TO_POST_COMMENT_REQUEST =
  'POST/REPLY_TO_POST_COMMENT_REQUEST';
export const REPLY_TO_POST_COMMENT_SUCCESS =
  'POST/REPLY_TO_POST_COMMENT_SUCCESS';
export const REPLY_TO_POST_COMMENT_FAILURE =
  'POST/REPLY_TO_POST_COMMENT_FAILURE';
...
export const GET_ALL_RPL_ON_COMMENT_REQUEST =
  'POST/GET_ALL_RPL_ON_COMMENT_REQUEST';
export const GET_ALL_RPL_ON_COMMENT_SUCCESS =
  'POST/GET_ALL_RPL_ON_COMMENT_SUCCESS';
export const GET_ALL_RPL_ON_COMMENT_FAILURE =
  'POST/GET_ALL_RPL_ON_COMMENT_FAILURE';
...
export const CREATE_POST_ON_TIMELINE_REQUEST =
  'POST/CREATE_POST_ON_TIMELINE_REQUEST';
export const CREATE_POST_ON_TIMELINE_SUCCESS =
  'POST/CREATE_POST_ON_TIMELINE_SUCCESS';
export const CREATE_POST_ON_TIMELINE_FAILURE =
  'POST/CREATE_POST_ON_TIMELINE_FAILURE';

...
// State for user news feed process
...
// State for guest user newsfeed process

export const GUEST_USER_NEWS_FEED = 'NEWSFEED/GUEST_USER_NEWS_FEED';
export const GUEST_USER_NEWS_FEED_REQUEST =
  'NEWSFEED/GUEST_USER_NEWS_FEED_REQUEST';
export const GUEST_USER_NEWS_FEED_SUCCESS =
  'NEWSFEED/GUEST_USER_NEWS_FEED_SUCCESS';
export const GUEST_USER_NEWS_FEED_FAILURE =
  'NEWSFEED/GUEST_USER_NEWS_FEED_FAILURE';
